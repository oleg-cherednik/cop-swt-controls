...
public class SimpleEditor
{
	...
	private void createToolBar()
	{
		...
		banner.setBackground(ColorExtension.CYAN);
	...
	{
		return hashImages.get(cmd.toLowerCase());
	}
...
//		hashImages.put("about", new Image(display,
