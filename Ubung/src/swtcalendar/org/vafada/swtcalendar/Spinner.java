...
public class Spinner extends Composite implements FocusListener {
    ...
    private Text text;
    private MultiTouchButton upButton;
    private MultiTouchButton downButton;
    ...
    public Spinner(Composite parent, int style) {
        ...
        }
        {
            ...
            upButton = new MultiTouchButton(buttonHolder, SWT.ARROW | SWT.CENTER | SWT.UP | SWT.NO_FOCUS);
            ...
            downButton = new MultiTouchButton(buttonHolder, SWT.ARROW | SWT.CENTER | SWT.DOWN | SWT.NO_FOCUS);
    ...
    public int getInitialRepeatDelay() {
        return 0;//upButton.getInitialRepeatDelay();
    }
