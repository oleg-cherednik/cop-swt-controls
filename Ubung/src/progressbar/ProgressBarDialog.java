...
/**
 * progress bar dialog. the first, you must know your app execute times, you need implement two method: process(int
 * times); initGuage(); you can implements method: cleanUp() doBefore() doAfter()
 * 
