...
public class CanvasExample
{
	public static void main(String[] args)
	{
		...
		/*
		 * Provide different resolutions for icons to get high quality rendering wherever the OS needs large icons. For
		 * example, the ALT+TAB window on certain systems uses a larger icon.
		 */
