...
public class CLabelGradient
{
	...
	private void createContents(Composite parent)
	{
		...
		one.setBackground(new Color[] { parent.getDisplay().getSystemColor(SWT.COLOR_RED),
		...
		// Set the background gradient
		two.setBackground(new Color[] { parent.getDisplay().getSystemColor(SWT.COLOR_WHITE),
		                parent.getDisplay().getSystemColor(SWT.COLOR_GRAY),
		                parent.getDisplay().getSystemColor(SWT.COLOR_DARK_GRAY),
		                parent.getDisplay().getSystemColor(SWT.COLOR_BLACK) }, new int[] { 33, 67, 100 });
	}
