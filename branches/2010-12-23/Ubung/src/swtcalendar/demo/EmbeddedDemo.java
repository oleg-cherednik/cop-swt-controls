...
import swtcalendar.org.vafada.swtcalendar.SWTCalendar;
import swtcalendar.org.vafada.swtcalendar.SWTCalendarEvent;
import swtcalendar.org.vafada.swtcalendar.SWTCalendarListener;
...
public class EmbeddedDemo
{
	public static void main(String[] args)
	{
		...
		Locale[] temp = new Locale[] {	Locale.US, Locale.UK, Locale.GERMANY, new Locale("ru", "RU")};
		int count = 0;
