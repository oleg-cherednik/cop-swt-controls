...
/**
 * A GUI dialog that layouts and displays a PDocument. It also allows to print the document.
 * 
...
class PrintPreview extends KDialog
{
	...
	public Image getPageImage(int page)
	{
		...
		try
		{
			...
			gc.fillRectangle(0, newImage.getBounds().height - 5, newImage.getBounds().width,
	...
	{
		/*
		 * funktioniert nicht: - Abgeschnittene Tabellen bleiben abgeschnitten - Skalierung geht nicht
		 */
