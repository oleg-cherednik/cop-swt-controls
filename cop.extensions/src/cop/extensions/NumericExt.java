 ...
 *
 * $Id: NumericExtension.java 366 2012-02-01 03:36:20Z oleg.cherednik $
 * $HeadURL: https://cop-swt-controls.googlecode.com/svn/trunk/cop.common/src/cop/common/extensions/NumericExtension.java $
 */
package cop.extensions;

import static cop.extensions.ArrayExt.EMPTY_CHAR_ARR;
import static cop.extensions.ArrayExt.invertArray;
import static cop.extensions.CommonExt.isNull;
import static cop.extensions.StringExt.DEFAULT_CHAR;
...
public final class NumericExt
{
	...
	public static <T extends Number> String expandToLimitWithChar(T value, int maxLength, char ch)
	{
		...
		if(value instanceof Byte || value instanceof Short || value instanceof Integer || value instanceof Long)
		{
			...
			res = StringExt.resizeString("" + newValue, maxLength, ch);
		}
