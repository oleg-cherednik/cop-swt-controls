...
//			{
//				IcoReader app = new IcoReader();
//				app.showIcon(args[0], IcoReader.BG_COLOR_1);
//				app.x = 0;
//				app.y = 225;
//				app.showIcon(args[0], IcoReader.BG_COLOR_2);
//			}
//			else
//			{
...
//		ICOFile f = new ICOFile(in);
//		Iterator it = f.getEntryIterator();
//		while(it.hasNext())
//		{
//			nl.ikarus.nxt.priv.imageio.icoreader.obj.IconEntry ie = (nl.ikarus.nxt.priv.imageio.icoreader.obj.IconEntry)it
//			                .next();
