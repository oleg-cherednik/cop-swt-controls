...
public class Menus
{
	...
	private void createPopUpMenu(Shell shell)
	{
		...
		// Create the images
//		star = new Image(shell.getDisplay(), this.getClass().getResourceAsStream("java2s.png"));
//		circle = new Image(shell.getDisplay(), this.getClass().getResourceAsStream("java2s.png"));
//		square = new Image(shell.getDisplay(), this.getClass().getResourceAsStream("java2s.png"));
//		triangle = new Image(shell.getDisplay(), this.getClass().getResourceAsStream("java2s.png"));
