...
class TownExampleRenderer extends KTableCellRenderer
{
	                ...
	                boolean clicked)
	{
		...
		else if(col == 1)
		{
			...
			SWTX.drawTextImage(gc, myContent.country, SWTX.ALIGN_HORIZONTAL_LEFT | SWTX.ALIGN_VERTICAL_TOP, null,
			                SWTX.ALIGN_HORIZONTAL_LEFT | SWTX.ALIGN_VERTICAL_CENTER, rect.x + 3, rect.y,
