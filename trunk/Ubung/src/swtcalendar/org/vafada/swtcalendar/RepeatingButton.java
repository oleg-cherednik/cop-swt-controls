...
{
	public static final int DEF_INIT_DELAY = 200; // ms
	public static final int DEF_REPEAT_DELAY = 100; // ms

	private int initDelay = DEF_INIT_DELAY;
	private int repeatDelay = DEF_REPEAT_DELAY;
