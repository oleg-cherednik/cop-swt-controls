...
public class PersonEditingSupport extends EditingSupport
{
	...
	public PersonEditingSupport(ColumnViewer viewer, int column)
	{
		...
		{
		case 2:
			editor = new ComboBoxCellEditor(((TableViewer)viewer).getTable(), gender);
			break;
		case 3:
	...
	{
		System.out.println("PersonEditingSupport.canEdit");
		return true;
	}
	...
	{
		System.out.println("PersonEditingSupport.getCellEditor()");
		return editor;
	}
	...
	{
		System.out.println("PersonEditingSupport.getValue()");
	...
	{
		System.out.println("PersonEditingSupport.setValue()");
