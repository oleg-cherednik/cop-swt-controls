 ...
 *
 * $Id: CalendarExtension.java 47 2010-08-16 12:19:28Z oleg.cherednik $
 * $HeadURL: https://cop-swt-controls.googlecode.com/svn/trunk/cop.common/cop.common/src/cop/common/extensions/CalendarExtension.java $
 */
...
import cop.common.enums.TitleTypeEnum;
 ...
 */
public final class CalendarExtension
{
	...
	{
		if(StringExtension.isEmpty(hour))
			return defaultHour;
	...
	{
		if(StringExtension.isEmpty(minute))
	...
	{
		if(StringExtension.isEmpty(second))
